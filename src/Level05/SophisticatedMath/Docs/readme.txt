...
To build static library and executable with GNU compiler:
...
To build dynamic library and executable with GNU compiler :
...
To build static library and executable with MSVC compiler :
...
To build dynamic library and executable with MSVC compiler :
...
Create a test suite of static lib with GNU compiler:
g++.exe   -I../Calculator -c ../Tests/test.cpp
g++.exe  test.o  -o bin/test.exe lib/libcalc-static.a

Create a test suite of static lib with MSVC compiler:
