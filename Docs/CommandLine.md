...
[Make everything as simple as possible but not simpler](https://www.interaction-design.org/literature/article/kiss-keep-it-simple-stupid-a-design-principle)!  
The [kiss](https://en.wikipedia.org/wiki/KISS_principle):kiss: principle for everyone.  
